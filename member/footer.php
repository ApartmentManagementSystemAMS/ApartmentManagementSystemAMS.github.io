      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="about-widget">
            ...
            <ul class="location-link">
              <li class="item">
                <i class="fas fa-map-marker-aMlt"></i>
                <p>India</p>
              </li>
              <li class="item">
        ...
        <div class="col-lg-3 col-md-5 mb-3 mb-md-0">
          ...
          <ul class="menu-link">
            <li>
              <a href="new.php">
                <i class="fa fa-angle-right" aria-hidden="true"></i>News</a>
            </li>
            <li>
              <a href="rules.php">
                <i class="fa fa-angle-right" aria-hidden="true"></i>Rules</a>
            </li>
            <li>
              <a href="maintenance.php">
                <i class="fa fa-angle-right" aria-hidden="true"></i>Maintenance</a>
            </li>
            <li>
              <a href="hall_booking.php">
                <i class="fa fa-angle-right" aria-hidden="true"></i>Hall-Booking</a>
            </li>
            <li>
              <a href="about.php">
  ...
  <div class="footer-bottom">
    <div class="container clearfix">
      <div class="copyright-text">
        <p>Developed by <a href="">Alodariya Tanvi, Ambasana Shweta, Gojiya Asmita, Mokariya Puri</a></p>
      </div>
